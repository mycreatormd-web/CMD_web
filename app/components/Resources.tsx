...
const Resources = () => {
  ...
  return (
    <section id="resources" className="relative py-12 sm:py-16 md:py-20 bg-gradient-to-b from-white via-green-50/15 to-white overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-green-200/25 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-blue-200/25 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute top-1/2 left-1/4 w-72 h-72 bg-cyan-100/20 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-1.5 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-green-100 to-blue-100 rounded-full mb-3 sm:mb-4"
          >
            <Zap className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-green-700" />
            <span className="text-xs sm:text-sm font-semibold text-green-700">FREE RESOURCES</span>
          </motion.div>
        ...
        {/* Resources Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 max-w-7xl mx-auto mb-12 md:mb-16">
          {resources.map((resource, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div className={`relative h-full bg-white rounded-xl md:rounded-2xl border-2 ${resource.borderColor} shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden cursor-pointer group`}>
                    {/* Animated Background */}
                    <div className={`absolute inset-0 bg-gradient-to-br ${resource.bgColor} opacity-0 group-hover:opacity-100 transition-opacity duration-300`} />

                    {/* Content Container */}
                    <div className="relative z-10 p-3 sm:p-4 md:p-6 lg:p-8 h-full flex flex-col">
                      {/* Emoji + Icon */}
                      <motion.div
                      ...
                      >
                        <span className="text-3xl sm:text-4">{resource.emoji}</span>
                        <div className={`w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br ${resource.color} flex items-center justify-center shadow-md`}>
                          <Icon className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-white" />
                        </div>
                      </motion.div>

                      {/* Type Badge */}
                      <div className={`inline-flex items-center gap-1 px-2 sm:px-2.5 py-1 bg-gradient-to-r ${resource.color} rounded-full mb-2 sm:mb-3 w-fit`}>
                      ...
                      <motion.h3
                        ...
                        className="text-base sm:text-lg md:text-xl font-bold text-gray-900 mb-2 sm:mb-3 leading-snug"
                      >
                        {resource.title}
                      </motion.h3>
                      ...
                      <motion.p
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: idx * 0.08 + 0.15, duration: 0.4 }}
                        className="text-xs sm:text-sm text-gray-700 leading-relaxed flex-grow mb-4 sm:mb-5"
                      >
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-purple-50 via-blue-50 to-green-50 rounded-xl md:rounded-2xl border-2 border-purple-200/50 p-6 sm:p-8 md:p-10 lg:p-12 text-center max-w-3xl mx-auto"
        >
          <motion.h3
            initial={{ opacity: 0, y: 15 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold rounded-lg sm:rounded-xl text-sm sm:text-base shadow-lg hover:shadow-xl transition-all"
          >
