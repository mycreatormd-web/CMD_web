            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl md:rounded-3xl border-2 border-gray-200 shadow-2xl overflow-hidden">
              <div className="p-4 md:p-6">
                    ...
                    <div className="flex justify-center gap-2 mt-3 md:mt-4 flex-wrap px-2">
                      {[
                        ...
                        <motion.div
                          ...
                          className={`${badge.color} text-white px-2 md:px-3 py-0.5 md:py-1 text-xs md:text-sm rounded-full font-bold shadow-lg`}
                        >
                          {badge.text}
                        </motion.div>
                      ))}
                ...
                <motion.div
                  ...
                  className="hidden md:flex justify-start items-center gap-2 px-2 text-xs text-gray-500 mt-2"
                >
                  <Zap className="w-3 h-3" />
                  <span>Discover her full journey</span>
                </motion.div>
              </div>
            </div>
          </motion.div>
